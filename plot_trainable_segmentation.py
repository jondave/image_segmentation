...
# full_img = data.skin() #default image from tutorial
full_img = imageio.imread("image_segmentation/image_0126.png")
...
training_labels[100:-20, 110:120] = 1 # poles
training_labels[100:-20, 540:550] = 1 # poles
training_labels[340:-10, 150:500] = 2 # ground
#training_labels[:50] = 3 # roof
training_labels[:50, 200:450] = 3 # roof
training_labels[200:-150, 150:500] = 4 # background
#training_labels[200:-200, 10:90] = 4 # background
training_labels[:50, :180] = 5 # table tops
training_labels[:50, 460:] = 5 # table tops
...
cv2.circle(img_new, (int(img.shape[0] / 2), int(center_x_poles)), 10, (0, 255, 0), -1)

# create mask just for ground
ground_mask = result == 2
# Calculate the centroid of the mask
centroid_ground = ndimage.measurements.center_of_mass(ground_mask)
# Extract the x and y coordinates of the centroid
center_x_ground, center_y_ground = centroid_ground
circle_radius = 10
cv2.circle(img_new, (int(img.shape[0] / 2), int(center_x_ground)), 10, (0, 0, 255), -1)
